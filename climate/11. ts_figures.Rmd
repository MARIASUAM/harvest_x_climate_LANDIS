...
jpeg(file = paste(di, "outputs/corrected_MIROC5_reg1_Prec.jpeg", sep = ""), width=6, height=4, units="in", res=300)
annual_sums %>%
...
jpeg(file = paste(di, "outputs/corrected_MIROC5_reg2_Prec.jpeg", sep = ""), width=6, height=4, units="in", res=300)
annual_sums %>%
  filter(variable == "Prec") %>%
  ggplot(aes(x = Year, y = value, color = scenario)) +
  geom_line() +
...
jpeg(file = paste(di, "outputs/corrected_MIROC5_reg3_Prec.jpeg", sep = ""), width=6, height=4, units="in", res=300)
annual_sums %>%
  filter(variable == "Prec") %>%
  ggplot(aes(x = Year, y = value, color = scenario)) +
  geom_line() +
...
jpeg(file = paste(di, "outputs/corrected_MIROC5_reg4_Prec.jpeg", sep = ""), width=6, height=4, units="in", res=300)
annual_sums %>%
  filter(variable == "Prec") %>%
  ggplot(aes(x = Year, y = value, color = scenario)) +
  geom_line() +
